        ...
        <div class="col-lg-12 category-content">
            ...
            <?php if (!empty($_SESSION['cart'])): ?>
                ...
                <form class="row g-3" method="post" action="cart/checkout">
                    ...
                    <?php if (!isset($_SESSION['user'])): ?>
                        <div class="col-md-6 offset-md-3">
                            <div class="form-floating mb-3">
                                <input type="email" name="email" class="form-control" id="email" placeholder="name@example.com" value="<?= getFieldsValue('email') ?>">
                        ...
                        <div class="col-md-6 offset-md-3">
                            <div class="form-floating mb-3">
                                <input type="password" name="password" class="form-control" id="password" placeholder="password" value="<?= getFieldsValue('password') ?>">
                        ...
                        <div class="col-md-6 offset-md-3">
                            <div class="form-floating mb-3">
                                <input type="text" name="name" class="form-control" id="name" placeholder="Name" value="<?= getFieldsValue('name') ?>">
                        ...
                        <div class="col-md-6 offset-md-3">
                            <div class="form-floating mb-3">
                                <input type="text" name="address" class="form-control" id="address" placeholder="Address" value="<?= getFieldsValue('address') ?>">
                    ...
                    <div class="col-md-6 offset-md-3">
                        <div class="form-floating mb-3">
                            <textarea name="note" class="form-control" placeholder="Leave a comment here" id="note" style="height: 100px"><?= getFieldsValue('note') ?></textarea>
