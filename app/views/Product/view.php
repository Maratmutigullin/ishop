...
/** @var $breadcrumbs \app\controllers\ProductController */
    ...
    <div class="row">
        ...
        <div class="col-md-8 order-md-1">
            ...
            <ul class="thumbnails list-unstyled clearfix">
                ...
                <li class="thumb-additional"><a class="thumbnail" href="<?=PATH . $item['img'] ?>" data-effect="mfp-zoom-in"><img src="<?= PATH . $item['img'] ?>" alt="<?= PATH . $product['title'] ?>"></a></li>
                <?php endforeach; ?>
                <?php endif; ?>
            </ul>
